...
<!-- CONFIGURATION -->
    ...
    <!-- iPad retina icon -->
    <link href="images/mobile/iphone152.png"
          sizes="152x152"
          rel="apple-touch-icon-precomposed">

    <!-- iPad retina icon (iOS < 7) -->
    <link href="images/mobile/iphone144.png"
          sizes="144x144"
          rel="apple-touch-icon-precomposed">

    <!-- iPad non-retina icon -->
    <link href="images/mobile/iphone76.png"
          sizes="76x76"
          rel="apple-touch-icon-precomposed">

    <!-- iPad non-retina icon (iOS < 7) -->
    <link href="images/mobile/iphone72.png"
          sizes="72x72"
          rel="apple-touch-icon-precomposed">

    <!-- iPhone 6 Plus icon -->
    <link href="images/mobile/iphone120.png"
          sizes="120x120"
          rel="apple-touch-icon-precomposed">

    <!-- iPhone retina icon (iOS < 7) -->
    <link href="images/mobile/iphone114.png"
          sizes="114x114"
          rel="apple-touch-icon-precomposed">

    <!-- iPhone non-retina icon (iOS < 7) -->
    <link href="images/mobile/iphone57.png"
          sizes="57x57"
          rel="apple-touch-icon-precomposed">
    ...
    <link href="images/mobile/startup1536x2008.png"
    ...
    <link href="images/mobile/startup2048x1496.png"
          media="(device-width: 768px) and (device-height: 1024px)
                 and (-webkit-device-pixel-ratio: 2)
    ...
    <link href="images/mobile/startup1242x2148.png"
    ...
    <link href="images/mobile/startup2208x1182.png"
          media="(device-width: 414px) and (device-height: 736px)
                 and (-webkit-device-pixel-ratio: 3)
                 and (orientation: landscape)"
          rel="apple-touch-startup-image">
    ...
    <link href="images/mobile/startup750x1294.png"
          media="(device-width: 375px) and (device-height: 667px)
                 and (-webkit-device-pixel-ratio: 2)"
          rel="apple-touch-startup-image">

    <!-- iPhone 5 startup image -->
    <link href="images/mobile/startup640x1096.png"
