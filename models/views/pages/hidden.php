...
echo Html::tag('h2','No lines no legends');
echo MulaffGraphWidgetV2::widget(['value'=>$string,'width'=>'33%','height'=>80]);
echo MulaffGraphWidgetV2::widget(['value'=>$string2,'width'=>'33%','height'=>80]);
echo MulaffGraphWidgetV2::widget(['value'=>$string3,'width'=>'33%','height'=>80,'type'=>2]);
echo Html::tag('h2','No legends');
echo MulaffGraphWidgetV2::widget(['value'=>$string,'width'=>'33%','height'=>80,'withLines'=>true]);
echo MulaffGraphWidgetV2::widget(['value'=>$string2,'width'=>'33%','height'=>80,'withLines'=>true]);
echo MulaffGraphWidgetV2::widget(['value'=>$string3,'width'=>'33%','height'=>80,'withLines'=>true,'type'=>2]);
echo Html::tag('h2','With legends and lines');
echo Html::tag('h3','Grays');
echo MulaffGraphWidgetV2::widget(['value'=>$string,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true]);
echo MulaffGraphWidgetV2::widget(['value'=>$string2,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true]);
echo MulaffGraphWidgetV2::widget(['value'=>$string3,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,'type'=>2]);
echo Html::tag('h3','Rainbow');
echo MulaffGraphWidgetV2::widget(['value'=>$string,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,  'color'=>MulaffGraphWidgetV2::COLOR_RAINBOW]);
echo MulaffGraphWidgetV2::widget(['value'=>$string2,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,  'color'=>MulaffGraphWidgetV2::COLOR_RAINBOW]);
echo MulaffGraphWidgetV2::widget(['value'=>$string3,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,'color'=>MulaffGraphWidgetV2::COLOR_RAINBOW,'type'=>2]);
echo Html::tag('h3','Gradient');
echo MulaffGraphWidgetV2::widget(['value'=>$string,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,  'color'=>MulaffGraphWidgetV2::COLOR_GRADIENT]);
echo MulaffGraphWidgetV2::widget(['value'=>$string2,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,  'color'=>MulaffGraphWidgetV2::COLOR_GRADIENT]);
echo MulaffGraphWidgetV2::widget(['value'=>$string3,'width'=>'33%','height'=>80,'withLegends'=>true,'withLines'=>true,'color'=>MulaffGraphWidgetV2::COLOR_GRADIENT,'type'=>2]);
