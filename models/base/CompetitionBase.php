...
*
    ...
    */
class CompetitionBase extends \yii\db\ActiveRecord
{
/**
* @inheritdoc
*/
...
return [
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\querys\CompetitionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\querys\CompetitionQuery(get_called_class());
}
}